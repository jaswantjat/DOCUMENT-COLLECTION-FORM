...
import { ArrowRight, ArrowLeft, Camera, Image, Zap, Home, Sun, Thermometer, Plus, X, AlertTriangle } from 'lucide-react';
...
function MultiPhotoUploader({ photos, minRequired, maxPhotos = 6, label, hint, onChange, error }: MultiPhotoProps) {
